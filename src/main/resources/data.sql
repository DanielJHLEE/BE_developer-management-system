...
(user_nm, user_age, emp_no, user_phone_no, user_grade, user_addr, user_gender, user_rank, worker_role, use_yn, join_dt, reg_dt, upd_dt)
VALUES
('김개발', 29, 1001, '01012345678', 'A', '서울 강남구', '남', '정규직', '주임', 'Y', '2024-01-01', NOW(), NULL),
('이프론트', 32, 1002, '01023456789', 'B', '서울 마포구', '여', '비정규직', '대리', 'Y', '2024-02-01', NOW(), NULL),
('박백엔드', 35, 1003, '01034567890', 'A', '경기 성남시', '남', '정규직', '과장', 'Y', '2024-03-01', NOW(), NULL),
('최풀스택', 31, 1004, '01045678901', 'S', '인천 연수구', '여', '비정규직', '책임', 'Y', '2024-04-01', NOW(), NULL),
('정주니어', 26, 1005, '01056789012', 'C', '서울 관악구', '남', '정규직', '사원','Y', '2024-05-01', NOW(), NULL),
('한리액트', 28, 1006, '01067890123', 'B', '서울 서초구', '여', '정규직', '대리', 'Y', '2024-06-01', NOW(), NULL),
('오스프링', 34, 1007, '01078901234', 'A', '경기 수원시', '남', '정규직', '과장', 'Y', '2024-07-01', NOW(), NULL),
('유노드', 30, 1008, '01089012345', 'B', '서울 송파구', '남', '비정규직', '주임', 'Y', '2024-08-01', NOW(), NULL),
('장데브옵스', 37, 1009, '01090123456', 'S', '경기 고양시', '남', '정규직', '책임', 'Y', '2024-09-01', NOW(), NULL),
('문데이터', 33, 1010, '01001234567', 'A', '서울 용산구', '여', '비정규직', '과장', 'Y', '2024-10-01', NOW(), NULL);
